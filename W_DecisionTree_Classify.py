...
from Ui_DecisionTree_Classify import Ui_MainWindow
...
class DecisionTree_Classify_Window(QMainWindow, Ui_MainWindow):
    def __init__(self):
        super(DecisionTree_Classify_Window, self).__init__()
        self.setupUi(self)
        pixmap = QPixmap(None)
        self.result_path = ''
    ...
    def train_lr(self):
        try:
            ...
            model = DecisionTreeClassifier(max_depth=int(self.DSB_max_depth.value()))
...
if __name__ == '__main__':
    ...
    win = DecisionTree_Classify_Window()
    win.show()
    sys.exit(app.exec_())