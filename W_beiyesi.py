...
class beiyesi_Window(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.beiyesi_testsize.setValue(0.1)
        ...
        for button_name in self.group_buttons:
            ...
            if button:
                self.groups[button] = []
                self.group_states[button] = {'buttons':[],'textBrowser':'','lbl_img':'','dataset':'','beiyesi_testsize':0.1,'image_path':'','last_used_button': None} #初始化组别状态
        ...
        for button_name in self.page_buttons:
            ...
            if button:
                ...
                self.buttons.append(button)
                self.page_states[button] = {'buttons':[],'textBrowser':'','lbl_img':'','dataset':'','beiyesi_testsize':0.1,'image_path':''}
    ...
    def train_lr(self):
        try:
            ...
            test_size = float(self.beiyesi_testsize.value())
            ...
            if self.selected_group:
                ...
                self.page_states[self.selected_button]['beiyesi_testsize'] = self.beiyesi_testsize.value()
            #保存当前页面状态
    ...
    def save_group_state(self, group_button):
        ...
        if group_button:
            ...
            state = {'buttons':[], 
                     ...
                     'beiyesi_testsize':self.beiyesi_testsize.value(),
    ...
    def restore_group_state(self, group):
        ...
        if group in self.group_states:
            ...
            self.beiyesi_testsize.setValue(state['beiyesi_testsize'])
